...
public class UserApi {
    ...
    public static final String USER_GET_GETUSERINNFO = BASE_URL+"user/getUserInfo?uid=71";
    public static final String USER_POST_GETUSERINNFO = BASE_URL+"user/getUserInfo";
}
